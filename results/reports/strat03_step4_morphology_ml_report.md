...
flowchart TD
    ...
    DL1["3위: 2-Layer LSTM (순환 시퀀스 딥러닝)<br/>• OOS MCC: +0.0424 | 균형 정확도: 52.12%<br/>• 4년 거래수: 1,168회 | 승률: 88.01% | 패배 방어: 61.6% (225회)"]
    
    DL2["4위: 1D-CNN (합성곱 시퀀스 딥러닝)<br/>• OOS MCC: -0.0212 (과잉 방어로 거래 붕괴)<br/>• 4년 거래수: 55회"]
...
| **4위** | **Model A: 1D-CNN** | **시퀀스 CNN (PyTorch)** | 49.74% | -0.0212 | 98.24% | 44.29% | 97.3% (355회) | 55회 (일 0.03회 - 붕괴) |

---

## 4. 2부: 4년 풀 사이클 실거래 백테스트 결과 (Strategy 1 연동)

| 모델 / 필터 조건 | 4년 거래수 | 일일 빈도 | 실측 승률 | **패배 방어율 (Loss Defense)** | **Kelly 15% 최종 자산** | 올인 최초 파산 시점 |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| **Model C: XGBoost (Standard)** | **953회** | **0.56회** | **88.04%** | **68.8% (251회 방어)** | $0.0 | **2022-02-04 (1월 완벽 생존!)** |
| **Model D: Random Forest** | **599회** | **0.35회** | **87.81%** | **80.0% (292회 방어)** | **$0.4** | **2022-02-04 (1월 완벽 생존!)** |
| **Model B: 2-Layer LSTM** | 1,168회 | 0.69회 | 88.01% | 61.6% (225회 방어) | $0.0 | **2022-02-04 (1월 완벽 생존!)** |
| **Model A: 1D-CNN** | 55회 | 0.03회 | 81.82% | 97.3% (355회 방어) | $275.6 | 2022-03-31 (파산) |
| **None (필터 없음)** | 2,661회 | 1.56회 | 86.28% | 0.0% (기준선) | $0.0 | 2022-01-08 (파산) |
...
3. **트리 앙상블의 압승:**  
   정형 금융 시계열에서 **XGBoost와 Random Forest가 딥러닝(1D-CNN/LSTM)을 모든 핵심 지표(MCC, 균형정확도, OOS 일반화)에서 완벽히 제압**했습니다.
4. **최종 챔피언 엔진 확정:**  
